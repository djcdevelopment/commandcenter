...
rem ffmpeg/ffprobe come from a winget package that is on an interactive
rem PATH but not necessarily on this scheduled task's. The render lane
rem refuses to guess an encoder, so pin them.
...
:hearth_gotlog
C:\work\commandcenter\fleet-worker-node\.venv-omen\Scripts\python.exe -m hearth.kernel.gateway --callers hearth\var\callers.json --providers hearth.toolsurface.fs,hearth.toolsurface.git,hearth.toolsurface.testing,hearth.toolsurface.knowledge,hearth.toolsurface.summon,hearth.toolsurface.inference,hearth.toolsurface.execution_control,hearth.toolsurface.task_lane,hearth.toolsurface.fleet_harvest,hearth.toolsurface.patrol,hearth.toolsurface.masters_pet,hearth.toolsurface.dream,hearth.toolsurface.scheduler,hearth.toolsurface.am4,hearth.toolsurface.commander,hearth.toolsurface.build_requests,hearth.toolsurface.media_render,hearth.toolsurface.image_generate,hearth.toolsurface.media_generate,hearth.toolsurface.rotation,hearth.toolsurface.rungstate >> "%GWLOG%" 2>&1
