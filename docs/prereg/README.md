...
| card | tag | status |
|---|---|---|
| [SATURATION-SURFACE-LAP1.md](SATURATION-SURFACE-LAP1.md) — the B70 saturation surface under concurrent intake | `prereg-saturation-lap1-20260909` — **tagged 2026-09-09** | predictions committed `b662991`; protocol facts corrected 2026-09-09 (bearer required on `:8082`; symmetry gate located; duty-cycle reference absent); **compute-control reference captured 2026-09-09** (159.9 / 114.1 W p50 per card, ambient 26.7); no cell run |
