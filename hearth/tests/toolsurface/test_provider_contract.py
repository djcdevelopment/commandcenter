...
from hearth.toolsurface import fs, git, inference, knowledge, scheduler, summon, task_lane, testing

PROVIDERS = (fs, git, testing, knowledge, summon, inference, task_lane, scheduler)
