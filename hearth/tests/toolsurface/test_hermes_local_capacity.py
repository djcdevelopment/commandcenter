"""Builder 3's narrow-retry tests against the integrated Codex helper.

Local model authored the test body. Codex changed only this module's import
and added this provenance header. Raw outputs remain in qualification evidence.
Run: hearth-hermes-br-20260920-014532-19828821-2115d229, cc-builder-3.
"""
import datetime
import unittest
