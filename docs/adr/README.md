...
| [0043](0043-the-rung-goes-cold-when-idle.md) | The rung goes cold when idle: keep it warm, don't restart it | Accepted (2026-08-29); >60 s idle costs ~4×, a 1-token ping every 20 s prevents it entirely — supersedes 0041's trigger; held through the 2026-09-03 cutover and rotation proof; rung state implemented (`hearth/health/rungstate.py`) |
